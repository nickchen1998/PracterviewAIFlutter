                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(qf.userAnswer, style: textTheme.bodySmall),
                        ...
                        const SizedBox(height: 4),
                        Text(qf.aiFeedback, style: textTheme.bodySmall),
                      ],
                    ),
                  ),
                ],
      ...
      body: isExpanded(context)
          ? Padding(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SizedBox(width: 340, child: scorePanel),
